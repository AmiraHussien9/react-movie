...
export default function Movies() {
  ...
  return <>
    ...
    <div className="allMovie">
      <div className="movie-heading d-flex  justify-content-center flex-column ">
        <div className="overlayMovie"></div>

        <div className="container">
          <div className="home-content">
            <h4><span>NOXE</span> ORIGINAL</h4>
            <h1>STANGER THINGS</h1>
            <ul className='movieList'>
              <li className='itemOne'>97% match</li>
              <li>2017</li>
              <li>tv-14</li>
              <li>2 seasons</li>
            ...
            <p>
              When a young boy vanishes, a small town uncovers a mystery<br /> involving secret experiments ,terrifying supernatural forces<br /> and one strange little girl.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="container py-5">
        <div className="row ">
          <h4>My list</h4>
          {movies.map((movie, index) => <div key={index} className='col-md-3 movie'>

            <div className="card ">
              <Link to={`../Moviedetails/${movie.media_type}/${movie.id}`} className="card__cover">
                <img src={`https://image.tmdb.org/t/p/w500${movie.poster_path}`} alt="" srcSet="" className='w-100' />
